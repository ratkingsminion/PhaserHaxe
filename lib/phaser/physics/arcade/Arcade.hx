...
extern class Arcade {
	...
	function velocityFromAngle(angle:Float, ?speed:Float, ?point: { x:Float, y:Float } ):Dynamic; // returns same type as point or phaser.Point
	function velocityFromRotation(rotation:Float, ?speed:Float, ?point: { x:Float, y:Float } ):Dynamic; // returns same type as point or phaser.Point
	function accelerationFromRotation(rotation:Float, ?speed:Float, ?point: { x:Float, y:Float } ):Dynamic; // returns same type as point or phaser.Point
