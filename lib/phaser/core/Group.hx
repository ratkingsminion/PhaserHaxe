...
extern class Group {
	...
	function iterate(key:String, value:Dynamic, returnType:Int, ?callback:Dynamic, ?callbackContext:Dynamic, ?param1:Dynamic, ?param2:Dynamic, ?param3:Dynamic, ?param4:Dynamic, ?param5:Dynamic, ?param6:Dynamic):Void;
